  ...
  return (
    <div className="grid gap-y-1.5">
      ...
      <div className="relative flex flex-col">
        <button
          type="button"
          className="dropdown-button relative flex h-11 w-full select-none items-center rounded-lg border border-gray-300 dark:border-gray-700 px-3.5 py-2.5 outline-none focus:border-primary-300 focus:ring-4 focus:ring-primary-100"
          onClick={(e) => {
            e.preventDefault();
        ...
        >
          ...
          <span className="ml-2 flex text-tmd font-regular text-gray-500">
            {newBookmark.tag === "" ? (
              ...
              <span className="mr-1.5 flex h-6 select-none items-center justify-center rounded-md border border-gray-300 dark:border-gray-700 px-[0.5625rem] py-0.5 text-tsm font-medium dark:font-[400] text-gray-700 dark:text-white/80 last:mr-0">
                {newBookmark.tag}
              </span>
            )}
          </span>
        ...
        <AnimatePresence>
          {isOpen && (
            <motion.div
              ...
              className="absolute top-12 grid max-h-80 w-full select-none grid-cols-1 gap-y-1 overflow-auto rounded-lg border border-gray-200 bg-white dark:bg-gray-900 p-1.5 dark:border-gray-800/30"
            >
