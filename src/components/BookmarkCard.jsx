...
function BookmarkCard({ bookmark }) {
  ...
  return (
    <div className="bookmark-card flex rounded-2xl p-6 hover:bg-gray-25 dark:hover:bg-gray-800 max-sm:flex-col">
      <div className="mr-6 h-auto w-[10.5rem] min-w-[10.5rem] select-none max-sm:mb-6 max-sm:mr-0 max-sm:w-full">
        <a href={bookmark.url} target="_blank" rel="noreferrer">
          <img
            className="h-full w-full rounded-lg object-cover transition-all duration-200 ease-in-out hover:scale-105"
      ...
      <div className="flex w-full flex-col">
        ...
        <span className="mb-6 text-tmd font-regular text-gray-600 dark:font-sans dark:text-white/60">
