...
function NavButton({ Icon, text, route, onClick }) {
  ...
  return (
    <button
      ...
      className={`flex select-none items-center whitespace-nowrap rounded-md px-3 py-2 text-tmd font-semibold text-gray-700 hover:bg-gray-25 dark:font-medium dark:text-white/90 dark:hover:dark:bg-gray-800/30 ${
