function HeaderButton({ text, isPrimary, onClick }) {
  return (
    <button
      ...
      className={`flex h-10 select-none items-center justify-center whitespace-nowrap rounded-lg px-4 py-2.5 text-tsm font-semibold outline-none focus:ring-4 active:ring-4 ${
        isPrimary
